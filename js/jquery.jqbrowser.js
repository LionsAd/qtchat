 ...
 * NOTE:
 *
 * Changes to avoid problems with various jQuery UI plugins.
 * - The object $.browser are changed to $.browsers.
 */
...
new function() {
     ...
     * jQBrowser plugin, accessed externally through the $.browsers object.
     * See the relevant function definition later in the source for further
     * information.
     *
     * $.browsers.browser()
     * $.browsers.version.number()
     * $.browsers.version.string()
     * $.browsers.OS()
     *
     * $.browsers.aol()
     * $.browsers.camino()
    ...
    // Allow external access to the 'Public' interface through the $.browsers
    // object.
    $.browsers = Public;
    ...
    for( var  i = 0,                    // counter
        ...
        if( data[i].browser() ) { // we have a match
            ...
            // $.browsers.browser() will now return the correct browser.
    ...
    for( var  i = 0,                  // counter
       ...
       i++
        ...
        if( data[i].OS() ) { // we have a match
            ...
            // $.browsers.OS() will now return the correct OS.
